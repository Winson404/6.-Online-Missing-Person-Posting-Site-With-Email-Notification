<title>I-LaFi | Post missing person</title>
              ...
              <form action="process_save.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-lg-5">
                       <div class="form-group">
                          <label>Complete Name of Missing Person (Required)</label>
                   ...
                   <div class="col-lg-3">
                    ...
                    <div class="col-lg-2">
                       <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter Landmark Name" name="Hair" >
                       </div>
                    </div>
                    <div class="col-lg-3">
                       <div class="form-group">
                          <label>Natural Hair Color  (Optional)</label>
                          <input type="text" class="form-control" placeholder="Input Hair Color" name="Headhair" >
                       </div>
                    </div>
                    <div class="col-lg-4">
                       <div class="form-group">
                   ...
                   <!--  <div class="col-lg-3">
                    ...
                    <div class="col-lg-3 col-auto form-group mb-3">
                     <label for="contact">Missing Person's Cell Phone (Optional)</label>
                    ...
                    <div class="col-lg-3">
                       <div class="form-group">
                          <label>Missing Person's Social Media Username (Optional)</label>
                          <input type="email" class="form-control" placeholder="email@gmail.com" name="PersonEmail" id="email" onkeydown="validation()" onkeyup="validation()">
                          <span id="text"></span>
                       </div>
                    </div>
                    ...
                    <div class="col-lg-5">
                       <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Address" name="Personaddress" >
                       </div>
                    </div>
                   <!--  <div class="col-lg-3">
                       <div class="form-group">
                   ...
                   <!--  <div class="col-lg-4">
                       <div class="form-group">
                          ...
                          <input type="tel" class="form-control" pattern="[7-9]{1}[0-9]{9}" id="contact" name="Contact_completingform" placeholder = "9123456789" required maxlength="10" value="<?php echo $row['contact']; ?>">
                    ...
                    <div class="col-lg-4 col-auto form-group col-md-4 mb-3">
                     ...
                     <div class="col-lg-6">
                       <div class="form-group">
                          <label>Image of the Missing Person (Required)</label>
