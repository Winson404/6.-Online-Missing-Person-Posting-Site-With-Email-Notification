<title>I-LaFi | Update missing person's information</title>
                   ...
                   <div class="col-lg-4">
                    ...
                    <div class="col-lg-5">
                       <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Address" name="Personaddress" value="<?php echo $row['last_person_with_address']; ?>">
                       </div>
                    </div>
                   <!--  <div class="col-lg-3">
                       <div class="form-group">
                    ...
                    <div class="col-lg-4">
                       <div class="form-group">
                          ...
                          <select class="custom-select" name="repeatmissing" required>
                                 ...
                                 <?php if($row['repeat_missing'] == 'Yes'): ?>
                                    <option value="<?php echo $row['repeat_missing']; ?>"><?php echo $row['repeat_missing']; ?></option>
                                    <option value="No">No</option>
                                 <?php elseif($row['repeat_missing'] == 'No'): ?>
                                    <option value="<?php echo $row['repeat_missing']; ?>"><?php echo $row['repeat_missing']; ?></option>
