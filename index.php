 ...
 <section id="missing" class="testimonials section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <form method="POST">
          ...
          <label style = "text-Align: center; margin-Bottom: 20px">You Can Search by Entering the <strong style = "color:red">Name</strong>, <strong style = "color:red">Birthday</strong> or <strong style = "color:red">Address</strong> of the Missing Person You Want to Search</label>
        ...
        <?php
            ...
            $find = mysqli_query($conn, "SELECT * FROM posted WHERE name LIKE '%".$name."%' && dob LIKE '%".$dob."%' && city_from LIKE '%".$address."%' && status='Missing'");
        ...
        ?>
          ...
          <?php } } else { 
              $fetch = mysqli_query($conn, "SELECT * FROM posted WHERE status='Missing' LIMIT 6");
        ...
        <div class="row">
          ...
          <div class="col-lg-6 mt-4 mt-md-0">
            ...
            <?php endif; unset($_SESSION['success_email']); ?>
              <div class="text-center mt-3"><button type="submit" class="btn btn-primary" name="sendemail">Send Message</button></div>
            </form>
          </div>
