<title>I-LaFi | Profile update</title>
          ...
          <div class="col-lg-2">
              <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" name="update_admin" id="update_admin"><i class="fa-solid fa-floppy-disk"></i> Update</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
