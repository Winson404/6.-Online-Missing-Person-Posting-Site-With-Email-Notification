      ...
      <!--   <form method="POST">
          <div class="row d-flex justify-content-center">
            <div class="col-md-11 d-flex">
              <button class="btn btn-default"> Search</button><input type="text" class="form-control" placeholder="Enter name to search..." name="name">
              <button class="btn btn-primary" style="margin-left: 5px;" type="submit" name="search"> Search</button>
            </div>
          </div>
        </form>
         -->
        ...
        ?>
          ...
          <a href="all_missing_person.php"style="text-align: right; text-decoration: none;"><b>View All</b></a>
          ...
          <?php } } else { 
              $fetch = mysqli_query($conn, "SELECT * FROM posted");
